...
public class MqttTopic {
	 ...
	 * @see #publish(org.eclipse.paho.client.mqttv3.MqttMessage)
	 ...
	 */
	public org.eclipse.paho.client.mqttv3.MqttDeliveryToken publish(byte[] payload, int qos, boolean retained) throws org.eclipse.paho.client.mqttv3.MqttException, org.eclipse.paho.client.mqttv3.MqttPersistenceException {
	 ...
	 * of the message to complete. The returned {@link org.eclipse.paho.client.mqttv3.MqttDeliveryToken token} can be used
	 ...
	 */
	public org.eclipse.paho.client.mqttv3.MqttDeliveryToken publish(org.eclipse.paho.client.mqttv3.MqttMessage message) throws org.eclipse.paho.client.mqttv3.MqttException, MqttPersistenceException {
		org.eclipse.paho.client.mqttv3.MqttDeliveryToken token = new MqttDeliveryToken(comms.getClient().getClientId());
