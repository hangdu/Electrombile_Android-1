...
import phao.mqttv3.internal.NetworkModule;
import phao.mqttv3.logging.Logger;
import phao.mqttv3.logging.LoggerFactory;
 ...
 *
 * <p>This class implements the non-blocking {@link org.eclipse.paho.client.mqttv3.IMqttAsyncClient} client interface
...
//				}
	...
	/* (non-Javadoc)
	 * @see org.eclipse.paho.client.phao.mqttv3.IMqttAsyncClient#connect(java.lang.Object, org.eclipse.paho.client.phao.mqttv3.IMqttActionListener)
	 */
	public org.eclipse.paho.client.mqttv3.IMqttToken connect(Object userContext, org.eclipse.paho.client.mqttv3.IMqttActionListener callback)
			throws MqttException, MqttSecurityException {
		return this.connect(new MqttConnectOptions(), userContext, callback);
	}

	/* (non-Javadoc)
	 * @see org.eclipse.paho.client.phao.mqttv3.IMqttAsyncClient#connect()
	 */
	public org.eclipse.paho.client.mqttv3.IMqttToken connect() throws MqttException, MqttSecurityException {
		return this.connect(null, null);
	}

	/* (non-Javadoc)
	 * @see org.eclipse.paho.client.phao.mqttv3.IMqttAsyncClient#connect(org.eclipse.paho.client.phao.mqttv3.MqttConnectOptions)
	 */
	public org.eclipse.paho.client.mqttv3.IMqttToken connect(MqttConnectOptions options) throws MqttException, MqttSecurityException {
		return this.connect(options, null,null);
	}

	/* (non-Javadoc)
	 * @see org.eclipse.paho.client.phao.mqttv3.IMqttAsyncClient#connect(org.eclipse.paho.client.phao.mqttv3.MqttConnectOptions, java.lang.Object, org.eclipse.paho.client.phao.mqttv3.IMqttActionListener)
	 */
	public org.eclipse.paho.client.mqttv3.IMqttToken connect(MqttConnectOptions options, Object userContext, org.eclipse.paho.client.mqttv3.IMqttActionListener callback)
			throws MqttException, MqttSecurityException {
	...
	/* (non-Javadoc)
	 * @see org.eclipse.paho.client.phao.mqttv3.IMqttAsyncClient#disconnect(java.lang.Object, org.eclipse.paho.client.phao.mqttv3.IMqttActionListener)
	 */
	public org.eclipse.paho.client.mqttv3.IMqttToken disconnect( Object userContext, org.eclipse.paho.client.mqttv3.IMqttActionListener callback) throws MqttException {
		return this.disconnect(QUIESCE_TIMEOUT, userContext, callback);
	}

	/* (non-Javadoc)
	 * @see org.eclipse.paho.client.phao.mqttv3.IMqttAsyncClient#disconnect()
	 */
	public org.eclipse.paho.client.mqttv3.IMqttToken disconnect() throws MqttException {
		return this.disconnect(null, null);
	}

	/* (non-Javadoc)
	 * @see org.eclipse.paho.client.phao.mqttv3.IMqttAsyncClient#disconnect(long)
	 */
	public org.eclipse.paho.client.mqttv3.IMqttToken disconnect(long quiesceTimeout) throws MqttException {
		return this.disconnect(quiesceTimeout, null, null);
	}

	/* (non-Javadoc)
	 * @see org.eclipse.paho.client.phao.mqttv3.IMqttAsyncClient#disconnect(long, java.lang.Object, org.eclipse.paho.client.phao.mqttv3.IMqttActionListener)
	 */
	public org.eclipse.paho.client.mqttv3.IMqttToken disconnect(long quiesceTimeout, Object userContext, org.eclipse.paho.client.mqttv3.IMqttActionListener callback) throws MqttException {
	...
	/*
	 * (non-Javadoc)
	 * @see org.eclipse.paho.client.phao.mqttv3.IMqttAsyncClient#disconnectForcibly()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see org.eclipse.paho.client.phao.mqttv3.IMqttAsyncClient#disconnectForcibly(long)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see org.eclipse.paho.client.phao.mqttv3.IMqttAsyncClient#disconnectForcibly(long, long)
	 */
	 ...
	 */
	public org.eclipse.paho.client.mqttv3.IMqttToken checkPing(Object userContext, org.eclipse.paho.client.mqttv3.IMqttActionListener callback) throws MqttException{
	...
	/* (non-Javadoc)
	 * @see org.eclipse.paho.client.phao.mqttv3.IMqttAsyncClient#subscribe(java.lang.String, int, java.lang.Object, org.eclipse.paho.client.phao.mqttv3.IMqttActionListener)
	 */
	public org.eclipse.paho.client.mqttv3.IMqttToken subscribe(String topicFilter, int qos, Object userContext, org.eclipse.paho.client.mqttv3.IMqttActionListener callback) throws MqttException {
		return this.subscribe(new String[] {topicFilter}, new int[] {qos}, userContext, callback);
	}

	/* (non-Javadoc)
	 * @see org.eclipse.paho.client.phao.mqttv3.IMqttAsyncClient#subscribe(java.lang.String, int)
	 */
	public org.eclipse.paho.client.mqttv3.IMqttToken subscribe(String topicFilter, int qos) throws MqttException {
	 ...
	 * @see org.eclipse.paho.client.phao.mqttv3.IMqttAsyncClient#subscribe(java.lang.String[], int[])
	 */
	public org.eclipse.paho.client.mqttv3.IMqttToken subscribe(String[] topicFilters, int[] qos) throws MqttException {
	 ...
	 * @see org.eclipse.paho.client.phao.mqttv3.IMqttAsyncClient#subscribe(java.lang.String[], int[], java.lang.Object, org.eclipse.paho.client.phao.mqttv3.IMqttActionListener)
	 */
	public org.eclipse.paho.client.mqttv3.IMqttToken subscribe(String[] topicFilters, int[] qos, Object userContext, org.eclipse.paho.client.mqttv3.IMqttActionListener callback) throws MqttException {
	...
	/* (non-Javadoc)
	 * @see org.eclipse.paho.client.phao.mqttv3.IMqttAsyncClient#unsubscribe(java.lang.String, java.lang.Object, org.eclipse.paho.client.phao.mqttv3.IMqttActionListener)
	 */
	public org.eclipse.paho.client.mqttv3.IMqttToken unsubscribe(String topicFilter,  Object userContext, org.eclipse.paho.client.mqttv3.IMqttActionListener callback) throws MqttException {
		return unsubscribe(new String[] {topicFilter}, userContext, callback);
	}

	/* (non-Javadoc)
	 * @see org.eclipse.paho.client.phao.mqttv3.IMqttAsyncClient#unsubscribe(java.lang.String)
	 */
	public org.eclipse.paho.client.mqttv3.IMqttToken unsubscribe(String topicFilter) throws MqttException {
	 ...
	 * @see org.eclipse.paho.client.phao.mqttv3.IMqttAsyncClient#unsubscribe(java.lang.String[])
	 */
	public org.eclipse.paho.client.mqttv3.IMqttToken unsubscribe(String[] topicFilters) throws MqttException {
	 ...
	 * @see org.eclipse.paho.client.phao.mqttv3.IMqttAsyncClient#unsubscribe(java.lang.String[], java.lang.Object, org.eclipse.paho.client.phao.mqttv3.IMqttActionListener)
	 */
	public IMqttToken unsubscribe(String[] topicFilters, Object userContext, org.eclipse.paho.client.mqttv3.IMqttActionListener callback) throws MqttException {
	...
	/* (non-Javadoc)
	 * @see org.eclipse.paho.client.phao.mqttv3.IMqttAsyncClient#publish(java.lang.String, byte[], int, boolean, java.lang.Object, org.eclipse.paho.client.phao.mqttv3.IMqttActionListener)
	 */
	public org.eclipse.paho.client.mqttv3.IMqttDeliveryToken publish(String topic, byte[] payload, int qos,
			boolean retained, Object userContext, org.eclipse.paho.client.mqttv3.IMqttActionListener callback) throws MqttException,
	...
	/* (non-Javadoc)
	 * @see org.eclipse.paho.client.phao.mqttv3.IMqttAsyncClient#publish(java.lang.String, byte[], int, boolean)
	 */
	public org.eclipse.paho.client.mqttv3.IMqttDeliveryToken publish(String topic, byte[] payload, int qos,
	...
	/* (non-Javadoc)
	 * @see org.eclipse.paho.client.phao.mqttv3.IMqttAsyncClient#publish(java.lang.String, org.eclipse.paho.client.phao.mqttv3.MqttMessage)
	 */
	public org.eclipse.paho.client.mqttv3.IMqttDeliveryToken publish(String topic, MqttMessage message) throws MqttException, 	MqttPersistenceException {
		return this.publish(topic, message, null, null);
	}

	/* (non-Javadoc)
	 * @see org.eclipse.paho.client.phao.mqttv3.IMqttAsyncClient#publish(java.lang.String, org.eclipse.paho.client.phao.mqttv3.MqttMessage, java.lang.Object, org.eclipse.paho.client.phao.mqttv3.IMqttActionListener)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.paho.client.phao.mqttv3.IMqttAsyncClient#close()
	 */
