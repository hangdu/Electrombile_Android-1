 ...
 * </p>
 * <p>
 * There are two styles of MQTT client, this one and {@link org.eclipse.paho.client.mqttv3.IMqttAsyncClient}.
 * <ul>
...
public IMqttToken connectWithResult(MqttConnectOptions options) throws MqttSecurityException, MqttException;
  ...
  public void unsubscribe(String[] topicFilters) throws MqttException;
	 ...
	 * <li>or use publish methods on the non-blocking client like {@link org.eclipse.paho.client.mqttv3.IMqttAsyncClient#publish(String, MqttMessage, Object, IMqttActionListener)}
	 * </ul>
	 * </p>
	 * <p>When building an application,
	 * the design of the topic tree should take into account the following principles
