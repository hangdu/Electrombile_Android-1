 ...
 *
 * <p>This class implements the blocking {@link org.eclipse.paho.client.mqttv3.IMqttClient} client interface where all
 ...
 * </p>
 *
 * @see org.eclipse.paho.client.mqttv3.IMqttClient
 */
public class MqttClient implements org.eclipse.paho.client.mqttv3.IMqttClient { //), DestinationProvider {
	//private static final String CLASS_NAME = MqttClient.class.getName();
	//private static final Logger log = LoggerFactory.getLogger(LoggerFactory.MQTT_CLIENT_MSG_CAT,CLASS_NAME);

	protected org.eclipse.paho.client.mqttv3.MqttAsyncClient aClient = null;  // Delegate implementation to MqttAsyncClient
	...
	public MqttClient(String serverURI, String clientId, MqttClientPersistence persistence) throws MqttException {
		aClient = new org.eclipse.paho.client.mqttv3.MqttAsyncClient(serverURI, clientId, persistence);
	}
	 ...
	 * @see IMqttClient#connect(MqttConnectOptions)
	 */
	public org.eclipse.paho.client.mqttv3.IMqttToken connectWithResult(MqttConnectOptions options) throws MqttSecurityException, MqttException {
		org.eclipse.paho.client.mqttv3.IMqttToken tok = aClient.connect(options, null, null);
	...
	/* (non-Javadoc)
	 * @see org.eclipse.paho.client.phao.mqttv3.IMqttClient#close()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.paho.client.phao.mqttv3.IMqttClient#getClientId()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.paho.client.phao.mqttv3.IMqttClient#getPendingDeliveryTokens()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.paho.client.phao.mqttv3.IMqttClient#getServerURI()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.paho.client.phao.mqttv3.IMqttClient#getTopic(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.paho.client.phao.mqttv3.IMqttClient#isConnected()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.paho.client.phao.mqttv3.IMqttClient#setCallback(org.eclipse.paho.client.phao.mqttv3.MqttCallback)
	 */
