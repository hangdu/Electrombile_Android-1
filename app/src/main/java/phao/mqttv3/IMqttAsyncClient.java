...
public interface IMqttAsyncClient {
	 ...
	 * @see #connect(MqttConnectOptions, Object, org.eclipse.paho.client.mqttv3.IMqttActionListener)
	 */
	 ...
	 * @see #connect(MqttConnectOptions, Object, org.eclipse.paho.client.mqttv3.IMqttActionListener)
	 */
	public IMqttToken connect(Object userContext, org.eclipse.paho.client.mqttv3.IMqttActionListener callback) throws MqttException, MqttSecurityException;
	 ...
	 */
	public IMqttToken connect(MqttConnectOptions options, Object userContext, org.eclipse.paho.client.mqttv3.IMqttActionListener callback) throws MqttException, MqttSecurityException;
	 ...
	 * @see #disconnect(long, Object, org.eclipse.paho.client.mqttv3.IMqttActionListener)
	 */
	public IMqttToken disconnect(Object userContext, org.eclipse.paho.client.mqttv3.IMqttActionListener callback) throws MqttException;
	 ...
	 * @throws MqttException for problems encountered while disconnecting
	 */
	public IMqttToken disconnect(long quiesceTimeout, Object userContext, org.eclipse.paho.client.mqttv3.IMqttActionListener callback) throws MqttException;
	 ...
	 * @see #publish(String, MqttMessage, Object, org.eclipse.paho.client.mqttv3.IMqttActionListener)
	 ...
	 */
	public IMqttDeliveryToken publish(String topic, byte[] payload, int qos,
									  boolean retained, Object userContext, org.eclipse.paho.client.mqttv3.IMqttActionListener callback) throws MqttException, MqttPersistenceException;
	...
	public IMqttDeliveryToken publish(String topic, MqttMessage message,
									  Object userContext, org.eclipse.paho.client.mqttv3.IMqttActionListener callback) throws MqttException, MqttPersistenceException;
	 ...
	 * @throws MqttException if there was an error registering the subscription.
	 */
	public IMqttToken subscribe(String topicFilter, int qos, Object userContext, org.eclipse.paho.client.mqttv3.IMqttActionListener callback)
	 ...
	 */
	public IMqttToken subscribe(String[] topicFilters, int[] qos, Object userContext, org.eclipse.paho.client.mqttv3.IMqttActionListener callback)
			throws MqttException;
	 ...
	 * @throws MqttException if there was an error unregistering the subscription.
	 */
	public IMqttToken unsubscribe(String topicFilter, Object userContext, org.eclipse.paho.client.mqttv3.IMqttActionListener callback)
			throws MqttException;
	 ...
	 * @throws MqttException if there was an error unregistering the subscription.
	 */
	public IMqttToken unsubscribe(String[] topicFilters, Object userContext, org.eclipse.paho.client.mqttv3.IMqttActionListener callback)
			throws MqttException;
	 ...
	 * each non-blocking method or using setting a {@link org.eclipse.paho.client.mqttv3.IMqttActionListener} on the
