...
public class LoggerFactory {
	 ...
	 */
	public final static String MQTT_CLIENT_MSG_CAT = "org.eclipse.paho.client.phao.mqttv3.internal.nls.logcat";
	 ...
	 */
	private static String jsr47LoggerClassName = "org.eclipse.paho.client.phao.mqttv3.logging.JSR47Logger";
	 ...
	 * @throws Exception
	 */
	public static org.eclipse.paho.client.mqttv3.logging.Logger getLogger(String messageCatalogName, String loggerID) {
		String loggerClassName = overrideloggerClassName;
		org.eclipse.paho.client.mqttv3.logging.Logger logger = null;
...
//		}
	 ...
	 */
	private static org.eclipse.paho.client.mqttv3.logging.Logger getLogger(String loggerClassName, ResourceBundle messageCatalog, String loggerID, String resourceName) { //, FFDC ffdc) {
		org.eclipse.paho.client.mqttv3.logging.Logger logger  = null;
		Class logClass = null;
		...
		if (null != logClass) {
			...
			try {
				logger = (org.eclipse.paho.client.mqttv3.logging.Logger)logClass.newInstance();
