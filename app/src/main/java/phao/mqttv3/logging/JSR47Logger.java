 ...
 */
public class JSR47Logger implements org.eclipse.paho.client.mqttv3.logging.Logger {
	 ...
	 * @param loggerID			The suffix for the loggerName (will be appeneded to org.eclipse.paho.client.phao.mqttv3
...
//		loggerName = "org.eclipse.paho.client.phao.mqttv3." + ((null == loggerID || 0 == loggerID.length()) ? "internal" : loggerID);
		loggerName = loggerID;
