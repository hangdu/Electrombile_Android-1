 ...
 */
package phao.mqttv3.internal.security;
...
public class SSLSocketFactoryFactory {
	private static final String CLASS_NAME = "org.eclipse.paho.client.phao.mqttv3.internal.security.SSLSocketFactoryFactory";
	/**
	...
	public static String obfuscate(char[] password) {
		...
		String encryptedValue = xorTag
				+ new String(org.eclipse.paho.client.mqttv3.internal.security.SimpleBase64Encoder.encode(bytes));
	...
	public static char[] deObfuscate(String ePassword) {
		...
		byte[] bytes = null;
		try {
			bytes = org.eclipse.paho.client.mqttv3.internal.security.SimpleBase64Encoder.decode(ePassword.substring(xorTag
					.length()));
		} catch (Exception e) {
			return null;
		}
...
//	 * 
//	 * @see org.eclipse.paho.client.phao.mqttv3.internal.security.SSLSocketFactoryFactory#DEFAULT_PROTOCOL
//	 * 
//	 * @param configID
